...
- (void)addLabel{
    ...
    label = [[CustmboLabel alloc] initWithFrame:[_data[@"textRect"] CGRectValue]];
    label.textColor = [UIColor colorWithRed:50/255.0 green:50/255.0 blue:50/255.0 alpha:1];
    label.backgroundColor = self.backgroundColor;
    [self.contentView addSubview:label];
    
    detailLabel = [[CustmboLabel alloc] initWithFrame:[_data[@"subTextRect"] CGRectValue]];
